...
2. yield_data.csv - all of the yield data used in 001_modelling.R to model the relationship between yield and drought

3. individually_sequenced_crosses.csv - file containing information on the trees that we sequenced and that met the filtering criteria for the main dataset

4. 001_modelling.R - all the code used to model the relationship between yield and drought (drought metric generation, drought metric and model selection, reaction norm fitting, drought sensitivity analysis, etc.)
